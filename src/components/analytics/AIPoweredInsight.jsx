...
const AIPoweredInsights = () => {
	return (
		<motion.div
			className='dark:bg-gray-800 bg-gray-200 bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-6 border dark:border-gray-700 border-gray-300'
			initial={{ opacity: 0, y: 20 }}
			animate={{ opacity: 1, y: 0 }}
			transition={{ delay: 1.0 }}
		>
			<h2 className='text-xl font-semibold dark:text-gray-100 text-gray-900 mb-4'>AI-Powered Insights</h2>
