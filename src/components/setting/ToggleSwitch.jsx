...
const ToggleSwitch = ({label,isOn,onToggle}) => {
  return (
    <div className='flex justify-between items-center py-3'>
        ...
        <button className={`relative inline-flex items-center min-w-11 h-6 rounded-full transition-colors duration-300 focus:outline-none ${isOn?'bg-indigo-600':"bg-gray-600"}`}
        onClick={onToggle}
        >
